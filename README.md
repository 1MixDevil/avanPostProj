...
Автоматизировать дообучение нейрнонной сети. На данный момент для этой задачи нет простого и "элегантного" решения. В последних конференциях по развитию ии также поднимался этот вопрос, т.к. задача требует вмешательства в архитектуру замороженной, обученной нейронной сети. Однако мы собственное решение. 
